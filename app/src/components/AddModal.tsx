            ...
            <div className="card__editForm">
                ...
                <div>
                    ...
                    <div className="inputWrapper">
                        ...
                        <input name="newRegisseur" defaultValue={addModalData.regisseur} onChange={value => setNewRegisseur(value.target.value)} />
                    </div>
                </div>

                <Button onClick={() => {
                    submitAddModal(newName, newImageUrl, newGenre, newDescription, newRegisseur)
                    closeModal()
